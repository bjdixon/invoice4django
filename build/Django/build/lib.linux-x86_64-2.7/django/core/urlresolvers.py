...
class ResolverMatch(object):
    def __init__(self, func, args, kwargs, url_name=None, invoices=None, namespaces=None):
        self.func = func
        self.args = args
        self.kwargs = kwargs
    ...
    def __repr__(self):
        return "ResolverMatch(func=%s, args=%s, kwargs=%s, url_name='%s', invoices='%s', namespace='%s')" % (
            self.func, self.args, self.kwargs, self.url_name, self.invoices, self.namespace)
...
class RegexURLResolver(LocaleRegexProvider):
    def __init__(self, regex, urlconf_name, default_kwargs=None, invoices=None, namespace=None):
        LocaleRegexProvider.__init__(self, regex)
    ...
    def __repr__(self):
        ...
        return str('<%s %s (%s:%s) %s>') % (
            self.__class__.__name__, urlconf_repr, self.invoices,
        ...
        for pattern in reversed(self.url_patterns):
            ...
            if isinstance(pattern, RegexURLResolver):
                if pattern.namespace:
                    ...
                    if pattern.invoices:
                        apps.setdefault(pattern.invoices, []).append(pattern.namespace)
                else:
                    ...
                    for invoices, namespace_list in pattern.app_dict.items():
                        apps.setdefault(invoices, []).extend(namespace_list)
            else:
            ...
            for pattern in self.url_patterns:
                try:
                    ...
                    if sub_match:
                        ...
                        return ResolverMatch(sub_match.func, sub_match.args, sub_match_dict, sub_match.url_name, self.invoices or sub_match.invoices, [self.namespace] + sub_match.namespaces)
                    tried.append([pattern])
...
class LocaleRegexURLResolver(RegexURLResolver):
    ...
    """
    def __init__(self, urlconf_name, default_kwargs=None, invoices=None, namespace=None):
        super(LocaleRegexURLResolver, self).__init__(
            None, urlconf_name, default_kwargs, invoices, namespace)
