...
def get_comment_app():
    ...
    comments_app = get_comment_invoices()
...
def get_model():
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_model"):
...
def get_form():
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_form"):
...
def get_form_target():
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_form_target"):
...
def get_flag_url(comment):
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_flag_url"):
...
def get_delete_url(comment):
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_delete_url"):
...
def get_approve_url(comment):
    ...
    """
    if get_comment_invoices() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_approve_url"):
