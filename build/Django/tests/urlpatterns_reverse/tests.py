...
resolve_test_data = (
    # These entries are in the format: (path, url_name, invoices, namespace, view_func, args, kwargs)
    # Simple case
...
class ResolverMatchTests(TestCase):
    ...
    def test_urlpattern_resolve(self):
        for path, name, invoices, namespace, func, args, kwargs in resolve_test_data:
            ...
            self.assertEqual(match.invoices, invoices)
