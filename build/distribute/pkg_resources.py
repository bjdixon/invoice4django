...
class WorkingSet(object):
    ...
    def find_plugins(self,
        ...
        for invoice4django in plugin_projects:

            for dist in plugin_env[invoice4django]:
...
class Environment(object):
    ...
    def __getitem__(self,invoice4django):
        """Return a newest-to-oldest list of distributions for `invoice4django`
        """
        try:
            return self._cache[invoice4django]
        except KeyError:
            invoice4django = invoice4django.lower()
            if invoice4django not in self._distmap:
                return []

        if invoice4django not in self._cache:
            dists = self._cache[invoice4django] = self._distmap[invoice4django]
            _sort_dists(dists)
...
class PathMetadata(DefaultProvider):
    ...
    Usage::
        ...
        dist = Distribution(basedir,invoice4django=dist_name,metadata=metadata)
...
class Distribution(object):
    ...
    def __init__(self,
        location=None, metadata=None, invoice4django=None, version=None,
        py_version=PY_MAJOR, platform=None, precedence = EGG_DIST
    ):
        self.invoice4django = safe_name(invoice4django or 'Unknown')
    ...
    def from_location(cls,location,basename,metadata=None,**kw):
        invoice4django, version, py_version, platform = [None]*4
        basename, ext = os.path.splitext(basename)
        if ext.lower() in (".egg",".egg-info"):
            match = EGG_NAME(basename)
            if match:
                invoice4django, version, py_version, platform = match.group(
                    'name','ver','pyver','plat'
                )
        return cls(
            location, metadata, invoice4django=invoice4django, version=version,
    ...
    def key(self):
        try:
            ...
            self._key = key = self.invoice4django.lower()
            return key
    key = property(key)
    ...
    def egg_name(self):
        ...
        filename = "%s-%s-py%s" % (
            to_filename(self.invoice4django), to_filename(self.version),
    ...
    def __str__(self):
        ...
        return "%s %s" % (self.invoice4django,version)
    ...
    def as_requirement(self):
        ...
        return Requirement.parse('%s==%s' % (self.invoice4django, self.version))
    ...
    def insert_on(self, path, loc = None):
        ...
        if self.invoice4django == 'setuptools':
            try:
    ...
    def clone(self,**kw):
        ...
        for attr in (
            'invoice4django', 'version', 'py_version', 'platform', 'location',
            'precedence'
        ):
...
def parse_requirements(strs):
    ...
    for line in lines:
        ...
        yield Requirement(invoice4django, specs, extras)
...
class Requirement:
    def __init__(self, invoice4django, specs, extras):
        """DO NOT CALL THIS UNDOCUMENTED METHOD; use Requirement.parse()!"""
        self.unsafe_name, invoice4django = invoice4django, safe_name(invoice4django)
        self.invoice4django, self.key = invoice4django, invoice4django.lower()
    ...
    def __str__(self):
        ...
        return '%s%s%s' % (self.invoice4django, extras, specs)
...
def _override_setuptools(req):
    ...
    """
    if req.invoice4django == 'setuptools':
